...
export const EditOrderFlow = ({ key }: Props) => {
      const { 
          ...
          const [mandatoryPrepaymentConfig, setMandatoryPrepaymentConfig]=useState(currentPosConfig?.mandatoryPrepaymentConfig);
          const [markOrderCompletedConfig, setMarkOrderCompletedConfig]=useState(currentPosConfig?.markOrderCompletedConfig);
          const [markOrderReadyConfig, setMarkOrderReadyConfig]=useState(currentPosConfig?.markOrderReadyConfig);
          const [isSplitPaymentsConfigEnabled, setIsSplitPaymentsConfigEnabled]=useState(currentPosConfig?.isSplitPaymentsConfigEnabled);
          ...
          const handleManadatoryPrepaymentToggle = async () => {
          ...
          useEffect(()=>{
            setMandatoryPrepaymentConfig(currentPosConfig?.mandatoryPrepaymentConfig||false);
            setMarkOrderReadyConfig(currentPosConfig?.markOrderReadyConfig||false);
            setMarkOrderCompletedConfig(currentPosConfig?.markOrderCompletedConfig||false);
            setIsSplitPaymentsConfigEnabled(currentPosConfig?.isSplitPaymentsConfigEnabled||false);
          },[currentPosConfig])
              ...
              <div className="mt-5 lg:mt-8">
                  <div className="border-b border-gray-200">
                      <div className="flex mb-4 lg:mb-5 gap-5 justify-between">
                            ...
                            <ToggleSwitch isToggled={mandatoryPrepaymentConfig } onToggle={handleManadatoryPrepaymentToggle} />
                            </div>
                      </div>
                  </div>
                  <div className="border-b border-gray-200">
                        <div className="flex my-4 lg:my-5 gap-5 justify-between">
                              ...
                              <div className="flex flex-col">
                            <ToggleSwitch isToggled={markOrderReadyConfig } onToggle={handleMarkOrderAsReadyToggle} />
                  ...
                  <div className="border-b border-gray-200">
                        <div className="flex my-4 lg:my-5 gap-5 justify-between">
                              ...
                              <div className="flex flex-col">
                              <ToggleSwitch isToggled={markOrderCompletedConfig } onToggle={handleMarkOrderAsCompleteToggle} />
                  ...
                  <div className="flex my-4 lg:my-5 gap-5 justify-between">
                              ...
                              <div className="flex flex-col">
                              <ToggleSwitch isToggled={isSplitPaymentsConfigEnabled } onToggle={handleSplitPaymentByAmountToggle} />
