  ...
  return (
    <div className={twMerge(
      ...
      <div className='px-4'>
            ...
            <div className='p-4'>
                <Paragraph 
                  ...
                  classOverride={{
                    ...
                    content: 'font-semibold text-purple-700 text-[16px] leading-[24px] lg:text-[18px] lg:leading-[28px]'
                  }}
              ...
              <Paragraph 
                ...
                {data.passcode&&(
                    <div className='flex flex-row'>
                      ...
                      <div className='flex flex-direction'>
                          <p className=' flex items-center ml-1 font-bold text-lg leading-5 lg:text-base lg:leading-6 text-purple-700'>Show Code</p>
                      </div>
                    </div>
                )}
        ...
        <button className="font-semibold hover:text-rose-800 text-rose-700 bg-rose-50 text-[14px] leading-[20px] lg:text-[16px] lg:leading-[24px] px-4 !py-[10px] rounded-lg hover:bg-rose-100" onClick={props.onDeleteModalOpen}>Delete Staff Member</button>
      </div>
      </div>
